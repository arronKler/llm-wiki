...
- `wiki-ingest` for saving, importing, clipping, syncing, or absorbing a source.
- `wiki-query` for questions, research, comparisons, briefs, and evidence lookup.
- `wiki-maintain` for lint, cleanup, reindexing, deduplication, freshness, or repair.
- `wiki-configure` for setup, schema, policies, domains, adapters, or agent bridges.
